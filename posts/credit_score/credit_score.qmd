...
What if the model predict a low creditworthiness and the business wants to know why? Shapley values make this possible. Shapley values comes from cooperative game theory: for more details, check this [link](https://medium.com/the-modern-scientist/what-is-the-shapley-value-8ca624274d5a) and this [link](https://www.sciencedirect.com/science/article/abs/pii/S1574000502030163).
